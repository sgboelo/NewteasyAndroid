...
public class PopupOperationFailed extends Dialog {

    private TextView button;
    private TextView message;
    private CompositeOnClickListener buttonOnClickListener = new CompositeOnClickListener();

    public PopupOperationFailed(@NonNull Context context) {
        super(context);
        ...
        View layout = getLayoutInflater().inflate(R.layout.popup_operation_fail, null);
        ...
        buttonOnClickListener.addListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PopupOperationFailed.this.dismiss();
            }
        });
